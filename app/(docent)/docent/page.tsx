...
export default function DocentLoginPage() {
  ...
  const [email, setEmail] = useState("p.dejong@uu.nl");
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
          ...
          <div className="px-8 py-8">
            ...
            <p className="text-sm text-uu-text-secondary mb-8">
              Log in met je UU-account
            </p>
            ...
            <form onSubmit={handleSubmit} noValidate>
              ...
              <div className="mb-6">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="w-full pl-10 pr-12 py-3 rounded-lg border border-uu-border bg-uu-surface text-uu-text text-base placeholder:text-uu-text-secondary focus:outline-none focus:ring-2 focus:ring-uu-yellow focus:border-transparent transition-all duration-150"
                    placeholder="Wachtwoord"
                  />
                  <button
                    type="button"
                    onClick={() => setShowPassword((v) => !v)}
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-uu-text-secondary hover:text-uu-text cursor-pointer transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-uu-yellow rounded"
                    aria-label={
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full min-h-[44px] bg-uu-black hover:bg-uu-black/90 disabled:opacity-70 text-white font-semibold text-base rounded-lg transition-colors duration-200 cursor-pointer focus:outline-none focus:ring-2 focus:ring-uu-yellow focus:ring-offset-2 flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
            ...
            <div className="mt-5 text-center">
              <Link
                href="/docent/wachtwoord-vergeten"
                className="text-sm text-uu-text-secondary hover:text-uu-black underline underline-offset-2 transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-uu-yellow rounded"
              >
                Wachtwoord vergeten?
              </Link>
            </div>
